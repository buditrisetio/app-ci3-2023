    ...
    <div class="vstack gap-2 col-md-5 mx-auto mt-5">
        ...
        <div class="card-body text-center">
            <h1 class="card-title mt-4"><?= $heading?></h1>
                ...
                <form action="<?= base_url('master/simpan_pabrik')?>" method="post" enctype="multipart/form-data">
                <label style="margin-left: -250px; margin-top: 50px;" for="nama_pabrik"><h5>Nama Pabrik</h5></label>    
                    <div class="card col-md-5 mx-auto mt-2" style="width: 400px;">
                        ...
                        <ul class="list-group list-group-flush">  
                            <input class="list-group-item" type="hidden" name="id_pabrik">
                        </ul>  
                        <ul class="list-group list-group-flush">
                            <input class="list-group-item" style="font-style: italic;" type="text" name="nama_pabrik" placeholder="Masukkan nama pabrik..." required>
                        </ul>
                    </div>
